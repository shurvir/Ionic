...
var triviaApp = angular.module('starter', ['ui.router', 'ionic', 'ngCordova', 'trivia.controllers', 'stats.services'])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  // Each state's controller can be found in controllers.js
    ...
    .state('app.facts', {
        ...
        views: {
            'menuContent': {
                templateUrl: 'templates/menu-facts.html',
    ...
    .state('app.trivia', {
        url: '/trivia/:categoryID',
        views: {
            'menuContent': {
                templateUrl: 'templates/menu-trivia.html',
...
triviaApp.directive('statCards', function () {
    return {
        restrict: 'E',
        templateUrl: 'templates/statCards.html',
        controller: 'statCardsCtrl'
    };
});
